    ...
    <div className="min-h-screen bg-[#061D46] text-white">
      ...
      <section className="py-20 border-b border-white/10">
        <div className="mx-auto max-w-5xl px-6">
          <p className="text-xs font-semibold uppercase tracking-widest text-blue-400 mb-4 text-center">Team</p>
          <h2 className="text-2xl font-bold text-white text-center mb-3">Our story is still being written</h2>
          <p className="text-blue-200/40 text-center mb-12 max-w-xl mx-auto">
          ...
          <div className="grid gap-5 sm:grid-cols-3">
            {[1, 2, 3].map(i => (
              <div key={i} className="rounded-2xl border border-white/10 bg-white/5 p-6 text-center">
                <div className="mx-auto mb-4 h-16 w-16 rounded-full bg-white/10 border border-white/15" />
                <div className="h-3 w-24 mx-auto rounded bg-white/10 mb-2" />
                <div className="h-2 w-16 mx-auto rounded bg-white/5" />
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20">
        <div className="mx-auto max-w-xl px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link
              href="/contact"
              className="flex items-center gap-2 rounded-xl border border-white/15 px-5 py-3 text-sm font-medium text-blue-100 hover:border-white/25 hover:text-white transition-colors"
            >
