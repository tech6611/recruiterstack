...
export const PUT = withCapability('recruiting:edit', async (request, orgId, supabase, { params }) => {
...
export const DELETE = withCapability('recruiting:edit', async (request, orgId, supabase, { params }) => {
  const draftId = request.nextUrl.searchParams.get('draft_id')
