...
// Canonical intake-job lifecycle:
//   'draft'    → created, waiting for the hiring manager to fill the form
//   'approved' → HM submitted; recruiter reviewing / "To be Published"
