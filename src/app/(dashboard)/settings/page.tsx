...
export default function SettingsPage() {
  ...
  useEffect(() => {
    ...
    if (oauthParams.some(p => searchParams.get(p))) {
  ...
  const tabs: { id: TabId; label: string; icon: typeof SlidersHorizontal; adminOnly?: boolean }[] = [
  ...
  return (
    <div className="p-8 max-w-6xl">
      ...
      {/* OAuth toasts — visible regardless of tab */}
      {(oauthToast || googleToast || zoomToast || msToast) && (
            ...
            <form onSubmit={handleSave} className="space-y-6">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="rounded-2xl border border-slate-200 bg-white shadow-sm p-6 space-y-4">
                  ...
                  <p className="text-xs text-slate-400 -mt-2">Used in AI-drafted outreach emails</p>
          ...
          {activeTab === 'integrations' && (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="rounded-2xl border border-slate-200 bg-white shadow-sm p-6 space-y-4">
                ...
                <p className="text-xs text-slate-400 -mt-2">Post to a #channel on key events</p>
              ...
              <div className="rounded-2xl border border-slate-200 bg-white shadow-sm p-6 space-y-4">
                ...
                <p className="text-xs text-slate-400 -mt-2">Auto-create Meet links on interview scheduling</p>
              ...
              <div className="rounded-2xl border border-slate-200 bg-white shadow-sm p-6 space-y-4">
                ...
                <p className="text-xs text-slate-400 -mt-2">Auto-create Zoom meeting links on scheduling</p>
              ...
              <div className="rounded-2xl border border-slate-200 bg-white shadow-sm p-6 space-y-4">
                ...
                <p className="text-xs text-slate-400 -mt-2">Auto-create Teams links &amp; Outlook events</p>
