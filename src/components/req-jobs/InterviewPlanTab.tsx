...
const blankRound = (): Round => ({
  name: '', interview_type: 'video', duration_minutes: 45,
  interviewer_user_id: null, interviewer_name: null, interviewer_role: '', stage_id: null,
})
                  ...
                  <div className="mt-3 grid grid-cols-1 gap-3 pl-10 sm:grid-cols-4">
                    ...
                    <div>
                      ...
                      {!r.interviewer_user_id && (
                        <Input className="mt-1.5" value={r.interviewer_role}
                          onChange={e => update(i, { interviewer_role: e.target.value })} placeholder="or a role" />
                      )}
                    </div>
                    <div>
