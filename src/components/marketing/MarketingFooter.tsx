    ...
    <footer className="bg-[#061D46]">
      <div className="mx-auto max-w-6xl px-6 py-16">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm text-blue-100/50 leading-relaxed max-w-[200px]">
          ...
          {/* Product */}
          <div>
            <p className="mb-4 text-xs font-semibold uppercase tracking-widest text-blue-200/40">Product</p>
          ...
          {/* Company */}
          <div>
            <p className="mb-4 text-xs font-semibold uppercase tracking-widest text-blue-200/40">Company</p>
            <ul className="space-y-3">
              {[
          ...
          {/* Legal */}
          <div>
            <p className="mb-4 text-xs font-semibold uppercase tracking-widest text-blue-200/40">Legal</p>
            <ul className="space-y-3">
              {[
      ...
      <div className="border-t border-white/10 px-6 py-5">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-3 sm:flex-row">
          ...
          <p className="text-xs text-blue-200/30">Built with care for recruiters</p>
        </div>
      </div>
    </footer>
  )
